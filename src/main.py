...
def run_train(args, hparams):
    ...
    print("Trainable parameters: zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz")
    for name, param in parser.named_parameters():
        print(f"{name}: {param.size()} - trainable: {param.requires_grad}")

    trainalbe_name = ["lora_adpater", "VLBrigde"]
    freeze_parameters(parser, trainable_name=trainalbe_name)
    print("Trainable parameters: zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz")
    print_trainable_parameters(parser, show_trained_param=False)
    
    # Added for LoRA ----------------------------------------------------------------
    # parser = get_peft_model(parser, peft_config)
    # parser.print_trainable_parameters()
